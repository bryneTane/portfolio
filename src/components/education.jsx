...
const educationData = [
  {
    ...
    description:
      "Specialized in software development, web services (REST), and information system security. Gained hands-on experience with agile methodologies managing medium-scale software teams.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Intensive two-year preparatory program in Mathematics and Physics for entrance to engineering schools.",
    highlights: [
